...
func RegisterPostServiceHTTPServer(s *http.Server, srv PostServiceHTTPServer) {
	r := s.Route("/")
	r.POST("/v1/certificate/post/list", _PostService_ListPost0_HTTP_Handler(srv))
	r.GET("/v1/certificate/posts", _PostService_ListPost1_HTTP_Handler(srv))
	r.GET("/v1/certificate/post/{id}", _PostService_GetPost0_HTTP_Handler(srv))
	r.POST("/v1/certificate/post", _PostService_CreatePost0_HTTP_Handler(srv))
	r.PATCH("/v1/certificate/post/{post.id}", _PostService_UpdatePost0_HTTP_Handler(srv))
	r.PUT("/v1/certificate/post/{post.id}", _PostService_UpdatePost1_HTTP_Handler(srv))
	r.DELETE("/v1/certificate/post/{id}", _PostService_DeletePost0_HTTP_Handler(srv))
}
...
func (c *PostServiceHTTPClientImpl) DeletePost(ctx context.Context, in *DeletePostRequest, opts ...http.CallOption) (*DeletePostReply, error) {
	...
	pattern := "/v1/certificate/post/{id}"
...
func (c *PostServiceHTTPClientImpl) UpdatePost(ctx context.Context, in *UpdatePostRequest, opts ...http.CallOption) (*Post, error) {
	var out Post
	pattern := "/v1/certificate/post/{post.id}"
	path := binding.EncodeURL(pattern, in, false)
