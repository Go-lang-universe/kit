...
func RegisterPostServiceHTTPServer(s *http.Server, srv PostServiceHTTPServer) {
	r := s.Route("/")
	r.POST("/v1/fees/post/list", _PostService_ListPost0_HTTP_Handler(srv))
	r.GET("/v1/fees/posts", _PostService_ListPost1_HTTP_Handler(srv))
	r.GET("/v1/fees/post/{id}", _PostService_GetPost0_HTTP_Handler(srv))
	r.POST("/v1/fees/post", _PostService_CreatePost0_HTTP_Handler(srv))
	r.PATCH("/v1/fees/post/{post.id}", _PostService_UpdatePost0_HTTP_Handler(srv))
	r.PUT("/v1/fees/post/{post.id}", _PostService_UpdatePost1_HTTP_Handler(srv))
	r.DELETE("/v1/fees/post/{id}", _PostService_DeletePost0_HTTP_Handler(srv))
}
